...
$T \in \{10, \ldots, 49\}$ generations), the greedy search (run here
...
achieved a $T$ MAE of $11.4 \pm 4.9$ generations,
close to but slightly exceeding the design target of 10 generations.
The 95\% highest-density interval for $T$ achieved 85\% empirical coverage ---
...
The 95\% highest-density interval for $T$ (from MCMC) covered the true value
in 93\% of seeds --- above target and consistent across both admixture events
--- while the $\alpha$ delta-method CI coverage of 62\% remained below the
target of 85\% for the same reasons as in S2.
