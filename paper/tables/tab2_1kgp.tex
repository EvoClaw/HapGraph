...
$\hat{\alpha}$ is the $F_3$ method-of-moments estimate of the Source~A
ancestry proportion (the complementary proportion $1-\hat{\alpha}$ comes from
Source~B lineage); 95\% CI from the delta method.
...
\midrule
ASW & AFR & ESN (AFR) & FIN (EUR) & 0.213 [0.154, 0.271] & $-36.6$ & \citet{Bryc2015} \\
ACB & AFR & ESN (AFR) & FIN (EUR) & 0.112 [0.053, 0.171] & $-22.5$ & \citet{Bryc2015} \\
LWK & AFR & ESN (AFR) & TSI (EUR) & 0.024 [$-$0.035, 0.083] & $-7.2$ & --- \\
...
PJL & SAS & FIN (EUR) & STU (SAS) & 0.086 [0.027, 0.145] & $-11.9$ & \citet{Moorjani2013} \\
\bottomrule
\end{tabular}
\end{table}
